...
//
// This is Maintenance's own copy of the same function Food/Beverage already
// have (each app is a separately deployed Vercel project, so the code is
// duplicated rather than shared — see those apps' own copies for the same
// note). Same extraction prompt — it's generic to any purchase slip, not
// food-specific, so no per-app tuning was needed.
//
